...
float Vector3::Angle(const XMVECTOR & Xmvec) const
{
	//단위벡터로만든다
	Vector3 Src = Normalize(*this);
	Vector3 Dest = Normalize(Xmvec);
...
float Vector3::Angle(const XMFLOAT3 & XmFloat) const
{
	//단위벡터로만든다
	Vector3 Src = Normalize(*this);
	Vector3 Dest = Normalize(XmFloat);
...
float Vector3::Angle(float Val[3]) const
{
	//단위벡터로만든다
	Vector3 Src = Normalize(*this);
	Vector3 Dest = Normalize(Val);
...
float Vector3::Angle(int Val[3]) const
{
	//단위벡터로만든다
	Vector3 Src = Normalize(*this);
	Vector3 Dest = Normalize(Val);
