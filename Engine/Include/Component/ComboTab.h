...
protected:
	CComboTab();
	CComboTab(const CComboTab& cctab);
	virtual ~CComboTab();

private:
	class CColliderRect*	m_pCollider;
	COMBO_TAB_STATE		m_eState;
...
public:
	void Disable();
	void Enable();
	void SetSound(const string& strFileName, COMBO_TAB_STATE eState);
