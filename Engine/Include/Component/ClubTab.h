...
protected:
	CClubTab();
	CClubTab(const CClubTab& cltab);
	virtual ~CClubTab();

private:
	class CColliderRect*	m_pCollider;
	CLUB_TAB_STATE		m_eState;
...
public:
	void Disable();
	void Enable();
	void SetSound(const string& strFileName, CLUB_TAB_STATE eState);
