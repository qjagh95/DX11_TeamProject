...
private:
	CDamageNumber();
	CDamageNumber(const CDamageNumber& dnumber);
	~CDamageNumber();

private:
	vector<class CDamageNumber*> m_vecNumber;
...
public:
	void SetDotDamage(bool bDotDamage);
	void ClearNumber();
	void ClearVecNumber();
