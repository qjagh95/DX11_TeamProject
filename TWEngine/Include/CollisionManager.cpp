...
//
//		int iMaxX = (int)(vSectionMax.x - iterG->second->vMax.x) / (int)iterG->second->vCellLength.x;
//		int iMaxY = (int)(vSectionMax.y - iterG->second->vMax.y) / (int)iterG->second->vCellLength.y;
//		int iMaxZ = (int)(vSectionMax.z - iterG->second->vMax.z) / (int)iterG->second->vCellLength.z;
//
